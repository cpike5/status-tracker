...
namespace StatusTracker.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedBodyMatch = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    TimeoutSeconds = table.Column<int>(type: "integer", nullable: false, defaultValue: 10),
                    RetryCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 2),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SiteTitle = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckResults_EndpointId_Timestamp",
                table: "CheckResults",
                columns: new[] { "EndpointId", "Timestamp" },
                descending: new[] { false, true });

            migrationBuilder.CreateIndex(
                name: "IX_CheckResults_Timestamp",
                table: "CheckResults",
                column: "Timestamp");

            migrationBuilder.CreateIndex(
                name: "IX_MonitoredEndpoints_IsEnabled",
                table: "MonitoredEndpoints",
                column: "IsEnabled");

            migrationBuilder.CreateIndex(
                name: "IX_MonitoredEndpoints_SortOrder_Name",
                table: "MonitoredEndpoints",
